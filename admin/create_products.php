...
<?php 
    ...
    if(isset($_POST['create_product'])){
        ...
        if($stmt->execute()){
            header('location: product_dashboard.php?product_created=Product has been created successfully');
        }else{
                header('location: product_dashboard.php?product_failed=Could not delete products');
            }
    }
