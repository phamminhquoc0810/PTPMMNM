...
if(isset($_POST['update_images'])){
    ...
    if($stmt->execute()){
        header('location: product_dashboard.php?images_updated=Product has been updated successfully');
    }else{
        header('location: product_dashboard.php?images_failed=Could not update image products');
    }
}
else{
